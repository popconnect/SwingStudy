...
public class JListEx01 extends JFrame {
	...
	public JListEx01() {
		...
		/*
		 * list.setModel(new AbstractListModel() { String[] values = new String[] {"사과",
		 * "참외", "수박", "딸기", "사과", "참외", "수박", "딸기", "사과", "참외", "수박", "딸기", "사과", "참외",
		 * "수박", "딸기"}; public int getSize() { return values.length; } public Object
